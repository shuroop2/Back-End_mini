...
<html>
	...
	<body> 
		...
		<section class="section">
			<div class="wrap">
				<form id="form_login" method="post" action="<c:url value='/loginCheck'/>">
					<div class="div_login_panel">
	        			...
	        			<div class="div_login_id">
	          				...
	          				<input class="input_login_id" id="id" name="id" type="text" placeholder="아이디 입력">
	          				<div class="error_login_id">아이디 혹은 비밀번호를 다시 확인해주세요</div>
	        			</div>
				        <div class="div_login_password">
				          	<p class="text_login_password">비밀번호</p>
				          	<input class="input_login_password" id="pwd" name="pwd" type="password" placeholder="비밀번호 입력">
