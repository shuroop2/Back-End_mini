...
<html>
	...
	<!-- TOP -->
		...
		<section>
			<form id="formStayReservation" method="post" action="<c:url value='/stay_rsv_complete'/>"> 
			    <div class="final_price_line">
			     ...
			     <input type="hidden" name="roomPrice" value="${roomTypePrice }">
			     <input type="hidden" name="daterange2" value="${dateTime[0]}~${dateTime[1] }">
		 	 </form>
		  </section>
		  <!-- BOTTOM -->
